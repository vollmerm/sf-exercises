...
Proof.
  intro n. unfold beq_nat. induction n. intros. reflexivity. intros. inversion H. Qed.
...
Proof.
  ...
  Case "n = S m". intros. destruct m. inversion H. rewrite <- plus_n_Sm in H.
  rewrite <- plus_n_Sm in H. simpl in H. inversion H. apply IHn' in H1. inversion H1. reflexivity.
Qed.
...
Proof.
  ...
  Case "n = 0". simpl. intros m eq. destruct m. reflexivity. inversion eq.
  Case "n = S m". simpl. intros m eq. destruct m. inversion eq. apply IHn' in eq.
...
Theorem index_after_last: forall (n : nat) (X : Type) (l : list X),
     ...
     index n l = None.
Proof.
  intros n X l eq. generalize dependent n.
  induction l. intros. reflexivity.
  destruct n. intros. inversion eq. intros. simpl. apply IHl. inversion eq. reflexivity.
Qed.
(** [] *)
...
Theorem length_snoc''' : forall (n : nat) (X : Type) 
     ...
     length (snoc l v) = S n. 
Proof.
  intros. generalize dependent n. generalize dependent v.
  induction l. intros. simpl. inversion H. reflexivity.
  intros. destruct n. inversion H. simpl. apply f_equal. apply IHl. inversion H. reflexivity.
Qed.
