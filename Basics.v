...
Theorem andb_orb_false :
  forall (c : bool),
  (andb false c = orb false c) ->
  c = false.
Proof.
  intros c.
  destruct c.
...
Proof.
  ...
  intros c.
  intros H.
  rewrite -> andb_orb_true.
  reflexivity.
  rewrite -> H.
  reflexivity.
  intros c.
  intros H.
  rewrite -> andb_orb_false.
  reflexivity.
  rewrite -> H.
  reflexivity.
Qed.
